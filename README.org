...
#+END_SRC
*** S6-portable-utils
Source: https://www.skarnet.org/software/s6-portable-utils/s6-portable-utils-2.2.2.4.tar.gz \\
Download and extract the sources:
#+BEGIN_SRC shell
  wget https://www.skarnet.org/software/s6-portable-utils/s6-portable-utils-2.2.2.4.tar.gz
  tar -xf s6-portable-utils-2.2.2.4.tar.gz
  cd s6-portable-utils-2.2.2.4
#+END_SRC
Configure sources:
#+BEGIN_SRC shell
  ./configure                      \
...
#+END_SRC
*** S6-rc
Source: https://www.skarnet.org/software/s6-rc/s6-rc-0.5.1.4.tar.gz \\
Download and extract the sources:
#+BEGIN_SRC shell
  wget https://www.skarnet.org/software/s6-rc/s6-rc-0.5.1.4.tar.gz
  tar -xf s6-rc-0.5.1.4.tar.gz
  cd s6-rc-0.5.1.4
#+END_SRC
Configure sources:
#+BEGIN_SRC shell
...
#+END_SRC
*** S6-linux-init
Source: https://www.skarnet.org/software/s6-linux-init/s6-linux-init-1.0.4.2.tar.gz \\
Download and extract the sources:
#+BEGIN_SRC shell
  wget https://www.skarnet.org/software/s6-linux-init/s6-linux-init-1.0.4.2.tar.gz
  tar -xf s6-linux-init-1.0.4.2.tar.gz
  cd s6-linux-init-1.0.4.2
#+END_SRC
Configure sources:
#+BEGIN_SRC shell
  ./configure                      \
...
Download and extract the sources:
#+BEGIN_SRC shell
  wget https://github.com/dslm4515/MLFS-S6-Bootscripts/releases/download/3.02/MLFS-S6-Bootscripts-3.02.tar.xz
  tar -xf MLFS-S6-Bootscripts-3.02.tar.xz
  cd MLFS-S6-Bootscripts-3.02
#+END_SRC
Install bootscripts:
#+BEGIN_SRC shell
  cp -rav s6 /etc/
#+END_SRC
Compile =basic= database:
#+BEGIN_SRC shell
  s6-rc-compile /etc/s6/db/basic /etc/s6/db-src/basic
#+END_SRC
Create a link to the database to boot:
#+BEGIN_SRC shell
